 ...
 */
final class Version20210321174906 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE review (id INT AUTO_INCREMENT NOT NULL, hotel_id INT NOT NULL, score DOUBLE PRECISION NOT NULL, comment LONGTEXT DEFAULT NULL, created_date DATE NOT NULL, INDEX IDX_794381C63243BB18 (hotel_id), INDEX IDX_794381C6ADE9C86E (created_date), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
